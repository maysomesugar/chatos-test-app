...
// in chatos_test_app/test/sign_in_tests/sign_in_usecases_test/sign_in_usecases_test.dart.
...
class MockSignInRepository extends _i1.Mock implements _i3.SignInRepository {
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.UserModel>> signIn(String? email) =>
      (super.noSuchMethod(
        Invocation.method(
          #signIn,
          [email],
